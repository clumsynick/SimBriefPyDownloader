...
class SimBriefPyDownloader:
    def __init__(self, root):
        ...
        # Username
        ttk.Label(root, text="SimBrief Username:").grid(row=1, column=0, sticky='w', padx=5, pady=5)
...
"""
    ...
    def update_flight_info_display(self, flight_number, aircraft, origin, destination, is_new):
        display_text = f"Flight {flight_number} | Aircraft: {aircraft} | {origin} ➔ {destination}"
    ...
    def download_flightplan(self):
        ...
        try:
            ...
            flight_number = params.get("flight_number", "N/A")
            ...
            self.update_flight_info_display(flight_number, aircraft_type, origin_icao, destination_icao, is_new_route)
